# Google add: https://cloud.google.com/storage/docs/reference/libraries
...
def gdrive_download(id="16TiPfZj7htmTyhntwcZyEEAejOUxuT6m", file="tmp.zip"):
    # Downloads a file from Google Drive. from yolov5.add.google_utils import *; gdrive_download()
    t = time.time()
    file = Path(file)
