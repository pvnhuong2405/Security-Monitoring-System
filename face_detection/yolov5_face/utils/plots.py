...
def plot_wh_methods():  # from add.plots import *; plot_wh_methods()
        ...
        if len(targets) > 0:
            ...
            for j, box in enumerate(boxes.T):
                ...
                if labels or conf[j] > 0.25:  # 0.25 conf thresh
                    ...
                    plot_one_box(
                        box, mosaic, label=label, color=None, line_thickness=tl
                    )
...
def plot_test_txt():  # from add.plots import *; plot_test()
...
def plot_targets_txt():  # from add.plots import *; plot_targets_txt()
...
def plot_study_txt(
    path="study/", x=None
):  # from add.plots import *; plot_study_txt()
...
):  # from add.plots import *; plot_evolution()
...
def profile_idetection(start=0, stop=0, labels=(), save_dir=""):
    # Plot iDetection '*.txt' per-image logs. from add.plots import *; profile_idetection()
...
def plot_results_overlay(
    start=0, stop=0
):  # from add.plots import *; plot_results_overlay()
...
def plot_results(start=0, stop=0, bucket="", id=(), labels=(), save_dir=""):
    # Plot training 'results*.txt'. from add.plots import *; plot_results(save_dir='runs/train/exp')
